...
class SDFNet(nn.Module):
    def __init__(self):
        ...
        self.conv0 = nn.Conv2d(1, HIDDEN_SIZE, kernel_size=1, padding=0, bias=True)
        ...
        self.seq_sampling_64 = nn.Sequential(
            nn.Conv2d(HIDDEN_SIZE, HIDDEN_SIZE, kernel_size=3, padding="same", dilation=64, bias=True),
            nn.ReLU(),
            # nn.Conv2d(HIDDEN_SIZE, HIDDEN_SIZE, kernel_size=3, padding="same", dilation=64, bias=False)
        )
        # Sequential operation with kernel sampling from distance 32, preserving input/output size
        self.seq_sampling_32 = nn.Sequential(
            nn.Conv2d(HIDDEN_SIZE, HIDDEN_SIZE, kernel_size=3, padding="same", dilation=32, bias=True),
            nn.ReLU(),
        ...
        self.seq_sampling_16 = nn.Sequential(
            nn.Conv2d(HIDDEN_SIZE, HIDDEN_SIZE, kernel_size=3, padding="same", dilation=16, bias=True),
            nn.ReLU(),
        ...
        self.seq_sampling_8 = nn.Sequential(
            nn.Conv2d(HIDDEN_SIZE, HIDDEN_SIZE, kernel_size=3, padding="same", dilation=8, bias=True),
            nn.ReLU(),
        ...
        self.seq_sampling_4 = nn.Sequential(
            nn.Conv2d(HIDDEN_SIZE, HIDDEN_SIZE, kernel_size=3, padding="same", dilation=4, bias=True),
            nn.ReLU(),
        ...
        self.seq_sampling_2 = nn.Sequential(
            nn.Conv2d(HIDDEN_SIZE, HIDDEN_SIZE, kernel_size=3, padding="same", dilation=2, bias=True),
            nn.ReLU(),
        ...
        self.seq_stride_1 = nn.Sequential(
            nn.Conv2d(HIDDEN_SIZE, HIDDEN_SIZE, kernel_size=3, padding="same", dilation=1, bias=True),
            nn.ReLU(),
